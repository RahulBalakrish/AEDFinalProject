...
public class PhoneRentJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 160, 34));
        ...
        jPanel4.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 90, -1, -1));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PhoneRental/PhoneRental/rent_Phone.png"))); // NOI18N
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 300, 250, 240));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblCustomerId, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
        ...
        jPanel4.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 420, 360));
        ...
        jPanel4.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 423, 137));
        ...
        jPanel4.add(btnAproove, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 290, -1, 38));
        ...
        jPanel4.add(btnDeny, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 350, 92, -1));
        ...
        jPanel4.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 130, 424, 132));
        ...
        jPanel4.add(btnReturnLaptop, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 540, 151, -1));
        ...
        jPanel4.add(btnManagelaptop, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 540, -1, -1));
        ...
        jPanel4.add(btnLogout1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 600, -1, -1));

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 2220, 1450));
...
//************************************************************************************************************   
            String sql1 ="UPDATE Customer SET PhoneApprove = 'Booked'  WHERE CustomerID = '"+txtCustomerId.getText()+"' ";
...
//        lr.setVisible(false);
    ...
    private void btnDenyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDenyActionPerformed
        try {
            // TODO add your handling code here:
            String sql1 ="UPDATE Customer SET PhoneApprove = NULL  WHERE CustomerID = '"+txtCustomerId.getText()+"' ";
            c.updateDatabase(sql1);
...
//    }
    ...
    private void DisplayLaptopRentalRequest(){
        ...
        try{
            String sql = "SELECT * FROM Customer where PhoneApprove = 'Requested' ";
            ResultSet rs = c.selectDatabase(sql);
            DefaultTableModel model =(DefaultTableModel) tblLaptopRentalRequest.getModel();
            int rowCount = model.getRowCount();
            for (int i = rowCount - 1; i >= 0; i--) 
            ...
            while (rs.next()) {
                reg = rs.getString(1);
                brand = rs.getString(38);
                status = rs.getString(39);
                price = rs.getString(40);
