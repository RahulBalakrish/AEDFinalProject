 ...
 */
public class CustomerCarComplain extends javax.swing.JFrame {

    /**
     * Creates new form CustomerLaptopReturn
     */
     MySQLConnection c = new MySQLConnection();
    public CustomerCarComplain() {
        initComponents();
        DisplayCarOnRent();
...
public CustomerCarComplain(String s) {
        initComponents();
        showData(s);
          txtProductID.setEditable(false);
        txtCustomerId.setEditable(false);
    ...
    private void initComponents() {
        ...
        tblCarsOnRent = new javax.swing.JTable();
        ...
        tblCarsOnRent.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblCarsOnRent.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblCarsOnRentMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblCarsOnRent);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CC.png"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtRentId, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(364, 0, 880, 960));
        ...
        jLabel6.setText("Manage Car Rent");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 370, 960));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void tblCarsOnRentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCarsOnRentMouseClicked
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tblCarsOnRent.getModel();
        int MyIndex = tblCarsOnRent.getSelectedRow();
        txtRentId.setText(model.getValueAt(MyIndex,1).toString());
        txtProductID.setText(model.getValueAt(MyIndex,0).toString());
//        txtProductID.setText();
    }//GEN-LAST:event_tblCarsOnRentMouseClicked
    ...
    private void btnRaiseComplaintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRaiseComplaintActionPerformed
        // TODO add your handling code here:
         try {
        String sql="UPDATE Customer SET CarComplain = 'Requested'  WHERE CustomerID = '"+txtCustomerId.getText()+"' ";
        c.updateDatabase(sql);
        JOptionPane.showMessageDialog(this," Successfully Raised Request");
        String sql1 = "UPDATE Car SET Service = 'Requested'  WHERE Productid = '"+txtProductID.getText()+"' ";
    ...
    private void btnPaymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPaymentActionPerformed
        // TODO add your handling code here:
        String sql1 ="UPDATE Customer SET car_payment_status = 'Done', CarApprove = NULL ,CarDelay = NULL,CarFine = NULL,CarPrice = NULL,"
                + "CarComplain = NULL,CarRentID = NULL,CarRentDate = NULL,CarReturnDate = NULL, CarID = NULL WHERE CustomerID = '"+txtCustomerId.getText()+"' ";
            c.updateDatabase(sql1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerCarComplain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerCarComplain().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblCarsOnRent;
    ...
    private void DisplayCarOnRent() {
        ...
        try{
            ...
            String sql = "select * from Customer where CustomerID = '"+txtCustomerId.getText()+"' and CarApprove = 'Booked' ";
