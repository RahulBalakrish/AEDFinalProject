...
public class ManageLaptopTechnician extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(418, 30, 300, -1));

        btnLogout.setBackground(new java.awt.Color(0, 0, 0));
        btnLogout.setFont(new java.awt.Font("Segoe UI Semilight", 3, 14)); // NOI18N
        ...
        jPanel1.add(btnLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, -1, 20));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1570, 80));
        ...
        jPanel2.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, 160, -1));
        jPanel2.add(txtTechnicianId, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 150, 170, -1));
        jPanel2.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 220, 170, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Name");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, -1, 19));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Technician ID");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, -1, 19));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Password");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, -1, 19));
        ...
        jPanel2.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 320, -1, -1));
        ...
        jPanel2.add(Save, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, -1, -1));
        ...
        jPanel2.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 320, -1, -1));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 72, 500, 180));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/phone complaint.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, 150, 90));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, 70, 1570, 600));
...
//                }
                ...
                String Query = "Insert into LaptopTechnician (TechnicianID, Name,Password,ProductID )  values ('"+txtTechnicianId.getText()+"','"+txtName.getText()+"',"
                        + " '"+txtPassword.getText()+"','Not Assigned') ";
                c.insertDatabase(Query);
        ...
        else 
        {
              try {
                  if(txtPassword.getText().isEmpty()){
                   ...
                   if(txtTechnicianId.getText().isEmpty()){
                    JOptionPane optionPane = new JOptionPane("Technician ID cannot be empty", JOptionPane.ERROR_MESSAGE);
                    JDialog dialog = optionPane.createDialog("Error Message");
                    dialog.setAlwaysOnTop(true);
                    dialog.setVisible(true);
                    flag = 1;
...
//                  String Req = txtTechnicianId.getText();
                  String Query = "Update LaptopTechnician set  Name = '"+txtName.getText()+"' ,Password = '"+txtPassword.getText()+"'"
